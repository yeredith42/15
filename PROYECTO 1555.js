...
function redBalloon() {
  var red = createSprite(Math.round(random(20, 370)), 10, 10);
...
function blueBalloon() {
  var blue = createSprite(Math.round(random(20, 370)), 10, 10);
...
function greenBalloon() {
  var green = createSprite(Math.round(random(20, 370)), 10, 10);
